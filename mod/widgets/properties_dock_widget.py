...
class PropertiesDockWidget(QtGui.QDockWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.addtodsph_button = QtGui.QPushButton(__("DSPH 시뮬레이션 추가"))
        ...
        self.removefromdsph_button = QtGui.QPushButton(__("DSPH 시뮬레이션 제거"))
        ...
        self.motion_label.setText("&nbsp;<span>{}</span>".format(__("모션")))
        ...
        self.motion_prop = QtGui.QPushButton(__("설정"))
