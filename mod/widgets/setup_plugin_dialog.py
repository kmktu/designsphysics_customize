...
class SetupPluginDialog(QtGui.QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.ok_button = QtGui.QPushButton("확인")
        self.cancel_button = QtGui.QPushButton("취소")
        self.defaults_button = QtGui.QPushButton(__("기본값"))
        self.feature_support_button = QtGui.QPushButton(__("기능 지원 보고서"))
        ...
        self.tab_widget.addTab(self.executable_setup_widget, "실행파일")
        self.tab_widget.addTab(self.settings_setup_widget, "설정")
