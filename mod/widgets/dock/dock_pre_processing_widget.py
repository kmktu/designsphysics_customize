...
class DockPreProcessingWidget(QtGui.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.option_main_layout = QtGui.QHBoxLayout()
        ...
        self.add_processing_button = QtGui.QPushButton(__("더보기"))
        self.add_processing_button.setCheckable(True)
        ...
        self.add_processing_button.clicked.connect(self.clicked_add_processing_button)
        ...
        self.option_main_layout.addWidget(self.add_geometry_button)
        self.option_main_layout.addWidget(self.gencase_button)
        ...
        self.first_frame = QtGui.QFrame()
        self.frame_layout = QtGui.QVBoxLayout()
        self.frame_layout.addLayout(self.second_row_layout)
        self.frame_layout.addLayout(self.third_row_layout)
        self.first_frame.setLayout(self.frame_layout)
        self.first_frame.hide()

        self.main_layout.addWidget(self.first_frame)
        self.setLayout(self.main_layout)

    def clicked_add_processing_button(self):
        if self.add_processing_button.isChecked():
