...
class DockPostProcessingWidget(QtGui.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        # self.add_processing_button.toggle()
        ...
        self.fourth_row_layout.addWidget(self.partvtk_button)
        self.fourth_row_layout.addWidget(self.computeforces_button)
        ...
        self.third_row_layout.addWidget(self.add_processing_button)
        ...
        self.frame_layout.addLayout(self.fourth_row_layout)
        self.frame_layout.addLayout(self.second_row_layout)
        # self.second_frame.addLayout(self.first_row_layout)
        self.second_frame.setLayout(self.frame_layout)
        self.second_frame.hide()
        # self.second_row_layout.setVisible(False)
