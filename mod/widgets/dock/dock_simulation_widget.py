...
class DockSimulationWidget(QtGui.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.title_label = QtGui.QLabel("<b>" + __("시뮬레이션 실행") + "</b> ")
        ...
        self.execute_button = QtGui.QPushButton(__("실행"))
        ...
        self.additional_parameters_button = QtGui.QPushButton(__("추가 매개변수"))
    ...
    def on_ex_simulate(self):
        ...
        # print("final_params_ex : ", cmd_string)
